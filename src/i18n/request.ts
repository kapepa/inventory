...
export default getRequestConfig(async ({ locale }) => {
  ...
  return {
    ...
    messages: {
      ...
      "parishes-list": (await import(`../shared/lib/i18n/locales/${locale}/parishes-list.json`)).default,
      "groups-page": (await import(`../shared/lib/i18n/locales/${locale}/groups-page.json`)).default,
      "groups-list": (await import(`../shared/lib/i18n/locales/${locale}/groups-list.json`)).default,
      "groups-relations": (await import(`../shared/lib/i18n/locales/${locale}/groups-relations.json`)).default,
      ...
      "categories-list": (await import(`../shared/lib/i18n/locales/${locale}/categories-list.json`)).default,
